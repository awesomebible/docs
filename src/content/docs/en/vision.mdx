...
We are a community. WWe are not alone as Christians, and we want to show that.

Any code created by awesomeBible is open source, so that others can do something with it.

The texts on awesomeBible are released under [Creative Commons BY-SA 4.0](https://docs.awesomebible.de/en/lizenz/).
