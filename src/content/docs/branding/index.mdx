...
:::note
Wenn du das awesomeBible Logo verwendest, stelle bitte sicher, dass es mindestens 37 Pixel in alle Richtungen Platz ist, damit das Logo "Raum zum Atmen" hat.
:::

## Logo auf dunklem Hintergrund
Bitte benutze auf dunklen Hintergründen immer das weiße Logo.

![](../../../assets/branding/darkbg_wordmark.png)

## Logo auf hellem Hintergrund
Auf hellen Hintergründen sollte immer das schwarze Logo verwendet werden.

![](../../../assets/branding/lightbg_wordmark.png)

## Wordmark mit Farbverlauf
![](../../../assets/branding/mixedbg_gradient.png)
