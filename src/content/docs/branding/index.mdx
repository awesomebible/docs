...
## Schriftarten
Wir benutzen als unsere Schriftart auf allen awesomeBible-Websites [Inter](https://rsms.me/inter/) von Rasmus Andersson. Wenn du [eines der Logos](https://codeberg.org/awesomeBible/assets) verwenden willst - zum Beispiel in einem Poster, Sticker oder Flyer - verwende bitte wenn möglich auch Inter als Schriftart.

## Farbpalette
Wir haben nicht wirlich eine "feste" Farbpalette - es können immer Farben hinzukommen, aber dass sind so ziemlich die Basics:
...
## Download
Alle awesomeBible Assets finden sich in diesem [Git-Repository](https://codeberg.org/awesomeBible/assets) und lassen sich [hier](https://codeberg.org/awesomeBible/assets/archive/main.zip) als Zip herunterladen.
